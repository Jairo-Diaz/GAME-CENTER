...
<section Class="form-register">
  <form action="form_compras_xbox.php" method="post">
   <a><br><CENTER>JUEGOS XBOX SERIES X<CENTER><br></a>
...
if ($_POST){
  ...
  mysqli_query($mysqli, "UPDATE inventario_xbox SET unidades_existentes=$unidades_resultantes WHERE id_producto = $id_producto");

  $registro_compra = "INSERT INTO compras_xbox (id_compra, id_admin, nombre_admin, juego_nombre, juego_precio, unidades_a_comprar, id_producto) VALUES ('','$id_admin','$nombre_admin','$dato_nombre_juego','$dato_precio','$unidades_a_comprar','$id_producto')";
