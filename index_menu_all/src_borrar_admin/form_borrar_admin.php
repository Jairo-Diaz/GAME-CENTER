...
$consulta_datos_select = mysqli_query($mysqli,"SELECT *  FROM administradores");
?>
...
<section Class="form-register">
  <form action="" method="post">
   <a><br><CENTER>ELIMINAR ADMINISTRADOR<CENTER><br></a>
...
<?php   if(isset($_POST['dato']))
  {
      ...
      if ($_POST){
        mysqli_query($mysqli,"DELETE FROM administradores WHERE id_admin='$id_admin'");
      }
