...
<table >
  ...
  <tr>
    ...
    <td><?php echo $registro['id_admin']  ?></td>
    <td><?php echo $registro['nombre_admin']  ?></td>
    <td><?php echo $registro['fecha_compra']  ?></td>
    <td><?php echo $registro['juego_nombre']?></td>
    <td><?php echo "$ " .  $registro['juego_precio'] . " MXN"?></td>
    <td><?php echo $registro['unidades_a_comprar'] ?></td>
    <td><?php echo $registro['id_producto']  ?></td>

    <td>
    <?php
    $u=$registro['unidades_a_comprar'];
    $p=$registro['juego_precio'];
    $total= $u * $p;
    echo "$ $total MXN";
