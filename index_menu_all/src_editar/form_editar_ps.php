...
<section Class="form-register">
  <form action="" method="post">
   <a><br><CENTER>EDITAR JUEGO PLAY STATION 5<CENTER><br></a>
...
<?php   if(isset($_POST['dato']))
  {
      ...
      if ($_POST){
        mysqli_query($mysqli, "UPDATE inventario_ps SET juego_precio='$precio_nuevo', unidades_existentes = '$unidades_totales' where id_producto = '$id_producto'");
